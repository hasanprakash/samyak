...
<<<<<<< HEAD
    ...
    event_core = models.CharField(max_length=50, default=None, null=True)
    event_core_phone = models.CharField(max_length=10, default=999999999, null=True)
    event_coordinator = models.CharField(max_length=50, default=None, null=True)
    event_coordinator_phone = models.CharField(max_length=10, default=999999999, null=True)
...
>>>>>>> 265ca2b02d6398ab05c1d1cac5b6382914f3085a
